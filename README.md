...
[![版本](https://img.shields.io/badge/版本-v2.6.0-blue.svg)](https://gitee.com/hhxs2025/fn-appstores)
...
| **一键安装/更新** | 支持安装向导，WebSocket 实时推送下载进度，进度百分比显示 |
...
──► 2.3.1 ──► 2.3.2 ──► 2.3.3 ──► 2.3.4 ──► 2.4.0 ──► 2.4.1 ──► 2.5.0 ──► 2.5.1 ──► 2.5.2 ──► 2.6.0
```
